...
target("jsmodule-mqjs")
add_deps("mquickjs","cjson","yui","socket")
add_cflags(' -DBUILD_NO_MAIN=1 -DHAS_JS_MODULE -DCONFIG_CLASS_SOCKET -DCONFIG_CLASS_YUI  -I. -I../mquickjs -I../jsmodule -g ')
...
add_files(
    'js_module.c',
    '../jsmodule/js_common.c',  # 公共代码（lib/jsmodule）
    'mqjs_shim.c',
    # 'yui_stdlib.c',
