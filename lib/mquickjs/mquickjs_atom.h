 ...
 * Atom table offsets.
 *
 * The offsets differ between 32-bit and 64-bit builds because each ROM
 * string occupies 1 header word + ceil((len+1)/JSW) data words, and
 * JSW is 4 on 32-bit targets (ESP32-C3, RV32) vs 8 on 64-bit.
 *
 * The 32-bit offsets were extracted from mqjs_stdlib_32.h; the 64-bit
 * offsets were extracted from mqjs_stdlib.h.
 */
#ifdef JS_PTR64

/* 64-bit offsets (JSW = 8) */
...
/* 32-bit offsets (JSW = 4) — matches mqjs_stdlib_32.h */
#define JS_ATOM_null 0
