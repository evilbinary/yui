...
static const uint64_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  0x0000000000504354,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (3 << (JS_MTAG_BITS + 3)), /* "UDP" (offset=574) */
  0x0000000000504455,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "socket" (offset=576) */
  0x000074656b636f73,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "close" (offset=578) */
  0x00000065736f6c63,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "shutdown" (offset=580) */
  0x6e776f6474756873,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "connect" (offset=583) */
  0x007463656e6e6f63,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "listen" (offset=585) */
  0x00006e657473696c,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "accept" (offset=587) */
  0x0000747065636361,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (11 << (JS_MTAG_BITS + 3)), /* "getsockname" (offset=589) */
  0x6e6b636f73746567,
  0x0000000000656d61,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (11 << (JS_MTAG_BITS + 3)), /* "getpeername" (offset=592) */
  0x6e72656570746567,
  0x0000000000656d61,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "socketpair" (offset=595) */
  0x617074656b636f73,
  0x0000000000007269,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "setsockopt" (offset=598) */
  0x6f6b636f73746573,
  0x0000000000007470,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "getsockopt" (offset=601) */
  0x6f6b636f73746567,
  0x0000000000007470,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "send" (offset=604) */
  0x00000000646e6573,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "recv" (offset=606) */
  0x0000000076636572,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "sendto" (offset=608) */
  0x00006f74646e6573,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "recvfrom" (offset=610) */
  0x6d6f726676636572,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "inet_addr" (offset=613) */
  0x6464615f74656e69,
  0x0000000000000072,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "ntohl" (offset=616) */
  0x0000006c686f746e,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (16 << (JS_MTAG_BITS + 3)), /* "make_sockaddr_in" (offset=618) */
  0x636f735f656b616d,
  0x6e695f726464616b,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (2 << (JS_MTAG_BITS + 3)), /* "gc" (offset=622) */
  0x0000000000006367,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "load" (offset=624) */
  0x0000000064616f6c,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "setTimeout" (offset=626) */
  0x6f656d6954746573,
  0x0000000000007475,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (12 << (JS_MTAG_BITS + 3)), /* "clearTimeout" (offset=629) */
  0x6d69547261656c63,
  0x0000000074756f65,

  /* sorted atom table (offset=632) */
  JS_VALUE_ARRAY_HEADER(265),
  ...
  JS_ROM_VALUE(629), /* clearTimeout */
  JS_ROM_VALUE(578), /* close */
  JS_ROM_VALUE(394), /* clz32 */
  JS_ROM_VALUE(260), /* codePointAt */
  JS_ROM_VALUE(268), /* concat */
  JS_ROM_VALUE(583), /* connect */
  ...
  JS_ROM_VALUE(592), /* getpeername */
  JS_ROM_VALUE(589), /* getsockname */
  JS_ROM_VALUE(601), /* getsockopt */
  ...
  JS_ROM_VALUE(82), /* let */
  JS_ROM_VALUE(585), /* listen */
  JS_ROM_VALUE(624), /* load */
  JS_ROM_VALUE(386), /* log */
  JS_ROM_VALUE(402), /* log10 */
  JS_ROM_VALUE(400), /* log2 */
  JS_ROM_VALUE(618), /* make_sockaddr_in */
  ...
  JS_ROM_VALUE(606), /* recv */
  JS_ROM_VALUE(610), /* recvfrom */
  ...
  JS_ROM_VALUE(604), /* send */
  JS_ROM_VALUE(608), /* sendto */
  ...
  JS_ROM_VALUE(626), /* setTimeout */
  JS_ROM_VALUE(598), /* setsockopt */
  JS_ROM_VALUE(313), /* shift */
  JS_ROM_VALUE(555), /* show */
  JS_ROM_VALUE(580), /* shutdown */
  JS_ROM_VALUE(342), /* sign */
  JS_ROM_VALUE(370), /* sin */
  JS_ROM_VALUE(263), /* slice */
  JS_ROM_VALUE(576), /* socket */
  JS_ROM_VALUE(595), /* socketpair */
  ...
  /* global object properties (offset=2200) */
