...
> 版本：草案 v0.4 + V0/V1/V2 核心实现  
> 日期：2026-07-23  
> 状态：**V0 + V1 已实现；V2 核心已实现**（物理中间件 / 场景编辑器后置）。可运行 `app/game/demo.json`
...
| v0.4 | 2026-07-23 | V1 完成（动画/trigger/miniaudio/对象池）；V2 核心完成（tilemap/粒子/Game.perf）；物理中间件与场景编辑器后置 |
