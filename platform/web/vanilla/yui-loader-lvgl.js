(function () {
  ...
  var jsonPath = params.get("json") || "app/lvgl/app.json";
  var assetsDir = params.get("assets") || "app/assets";
  var wasmBase = "yui/";
  var wasmJs = "yui-web-lvgl.js";
  ...
  function tryLoadWasm() {
    return loadScript(wasmBase + wasmJs).then(function () {
      return wasmBase;
    }).catch(function () {
      ...
      return YuiModule({
        ...
        locateFile: function (path) {
          if (path.endsWith(".wasm")) {
            return wasmBase + "yui-web-lvgl.wasm";
          }
          if (path.endsWith(".data")) {
            return wasmBase + "yui-web-lvgl.data";
          }
